...
const EventsCards = () => {
  const events = [
    ...
    },
    {
      image: exportsIcon,
      title:
        "أكثر من 20 موردًا عالميًا للعلامات التجارية الخاصة بالحيوانات الأليفة",
      des: "لوريم إيبسوم هو نص افتراضي يستخدم في تصميم الصفحات والمواقع والتطبيقات",
    },
    {
      image: percentage,
    ...
    {
      image: contact,
      title: "التواصل مع نظراء الصناعة والحصول على عينات مجانية",
      des: "لوريم إيبسوم هو نص افتراضي يستخدم في تصميم الصفحات والمواقع والتطبيقات",
    },
    {
      image: settings,
      title: "جلسة تدريبية عن العلامات التجارية",
      des: "لوريم إيبسوم هو نص افتراضي يستخدم في تصميم الصفحات والمواقع والتطبيقات",
    },
    {
      image: people,
